...
\begin{document}
    ...
    \section{Schlüsselerzeugung}
        ...
        \subsection{Die Schlüssel}
            ...
            \end{description}
            Da die Schlüsselerzeugung meist von einer Schlüsselvergabestelle übernommen wird, sollte diese nach Berechnung der Schlüssel die Primzahlen $p$ und $q$, sowie das Ergebnis der zugehörigen Eulerfunktion $\varphi(n)$ löschen, damit auch im Falle einer Kompromittierung ihrer Server die Privatsphäre der Nutzer geschützt bleibt.\footcite[279]{dankmeier2006}
    ...
    \section{Ver- und Entschlüsselungs Algorithmus}
            ...
            \begin{enumerate}
                ...
                \end{equation}
            \end{enumerate}
            In Abbildung \ref{fig:encrypt} wird der Ablauf einer Verschlüsselung mit dem Programm \href{www.cryptool.org}{Cryptool 2} (www.cryptool.org) an einem Beispiel veranschaulicht. Aus Gründen der Übersichtlichkeit wurde hier anstelle der einzelnen Buchstaben der gesamte Text in eine Zahl umgewandelt und die Schlüsselgenerierung wurde dem Programm überlassen.
            \begin{figure}[h!]
            ...
            Um Bobs Nachricht lesen zu können, muss sie den Chiffretext mit der Dechiffrierfunktion \ref{eq:decrytion} entschlüsseln und wieder zurück in Buchstaben konvertieren.\footcite[77]{ertel2003} Dies wird in Abbildung \ref{fig:decrypt} veranschaulicht.
            \begin{equation}
