...
\begin{document}
    ...
    \subsection{Symmetrie}  %FIXME Ziatation
        ...
        \end{center}
        Um die Geheimhaltung zu gewährleisten muss das eingesetzte Verfahren so konzipiert sein, dass von dem öffentlichen Schlüssel $P$ keine Rückschlüsse auf den privaten Schlüssel $S$ gezogen werden können.\footcite[33]{beutelspacher2015} %FIXME Seitenumbruch
    ...
    \section{Ver- und Entschlüsselungs Algorithmus}
            ...
            \begin{enumerate}
                ...
                \end{equation}
            \end{enumerate}
            In Abbildung \ref{fig:encrypt} wird der Ablauf einer Verschlüsselung mit dem Programm \href{www.cryptool.org}{Cryptool 2} (www.cryptool.org) veranschaulicht. Aus Gründen der Übersichtlichkeit wurde hier anstelle der einzelnen Buchstaben der gesamte Text in eine Zahl umgewandelt und die Schlüsselgenerierung wurde dem Programm überlassen.
            \begin{figure}[h]
