...
\begin{document}
    ...
    Schwieriger wird es dann schon bei dem Titel des aktuellen Zeitabschnittes: \enquote{Digitales Informationszeitalter}. Nach \Citeauthor{dr.dr.jornlengsfeldDigitalesInformationszeitalterDr} sind hierbei die \enquote{Informations- und Kommunikationstechnologien} die prägenden Technologien.\autocite{dr.dr.jornlengsfeldDigitalesInformationszeitalterDr}
